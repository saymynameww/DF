...
# 读取个人信息
train_agg = pd.read_csv('../1DF-data/original_data/train_agg.csv',sep='\t')
test_agg = pd.read_csv('../1DF-data/original_data/test_agg.csv',sep='\t')
agg = pd.concat([train_agg,test_agg],copy=False)

# 日志信息
train_log = pd.read_csv('../1DF-data/original_data/train_log.csv',sep='\t')
test_log = pd.read_csv('../1DF-data/original_data/test_log.csv',sep='\t')
...
# 用户唯一标识
train_flg = pd.read_csv('../1DF-data/original_data/train_flg.csv',sep='\t')
test_flg = pd.read_csv('../1DF-data/original_data/submit_sample.csv',sep='\t')
test_flg['FLAG'] = -1
del test_flg['RST']
