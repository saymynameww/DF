...
if __name__ == "__main__":
    ...
    params = {'boosting_type': 'gbdt', 'objective': 'binary', 'metric': {'auc'}, 'num_leaves': 20, 'learning_rate': 0.01, 'feature_fraction': 0.9, 'bagging_fraction': 0.8, 'bagging_freq': 5, 'verbose': 0}
    cv_roc = []
    cv_prediction = []
    train_cv(params)
    predict_func() 
